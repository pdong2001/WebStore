...
namespace Web.Migrations
{
    ...
    [Migration("20211212085952_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Models.BillLine", b =>
                {
                    ...
                    b.Property<double>("OutboundPrice")
                        .HasColumnType("float");

                    b.Property<double>("Quantity")
                        .HasColumnType("float");

                    b.HasKey("BillId", "ItemDetailId");
            ...
            modelBuilder.Entity("Data.Models.ItemDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Data.Models.Receipt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Data.Models.ReceiptDetail", b =>
                {
                    ...
                    b.HasKey("ReceiptId", "ItemDetailId");
            ...
            modelBuilder.Entity("Data.Models.WebInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("BannerOneImageName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BannerThreeContent")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BannerThreeImageName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BannerTwoContent")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BannerTwoImageName")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("HeroImageOneName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HeroImageTwoName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Data.Models.BillLine", b =>
                {
                    b.HasOne("Data.Models.Bill", null)
                        .WithMany()
                        .HasForeignKey("BillId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Data.Models.ItemDetail", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Data.Models.Receipt", b =>
                {
                    b.HasOne("Data.Models.Provider", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Data.Models.ReceiptDetail", b =>
                {
                    ...
                    b.HasOne("Data.Models.Receipt", null)
                        .WithMany()
